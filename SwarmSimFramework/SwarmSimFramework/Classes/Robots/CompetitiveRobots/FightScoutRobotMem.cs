...
namespace SwarmSimFramework.Classes.Robots.CompetitiveRobots
{
    ...
    /// </summary>
    public class FightScoutRobotMem : RobotEntity
    {
        public FightScoutRobotMem() : this(Vector2.Zero) { }
        public FightScoutRobotMem(Vector2 middle, float amountOfFuel = 0,float orientation = 0 )
            : base(middle, 2.5f, "FightScoutRobotMem",null ,null , amountOfFuel, 0, 1, 100, 100, -100, orientation)
        {
            Health = 500;
