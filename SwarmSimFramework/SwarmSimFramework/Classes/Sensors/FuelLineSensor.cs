...
namespace SwarmSimFramework.Classes.Entities
{
    ...
    {
        public FuelLineSensor(Vector2 a, Vector2 b, Vector2 rotationMiddle, string name, float orientation = 0) : base(a, b, rotationMiddle, name, orientation)
        {
        }

        public FuelLineSensor(string name) : base(name)
        {
        }
